...
import Page from '@/app/gcl/hands-on/set-up-an-app-dev-environment-on-google-cloud/page';
import { DIAGRAMS } from '@/app/gcl/hands-on/set-up-an-app-dev-environment-on-google-cloud/constants';
