...
import inventory from '@/docs/migration-inventory/agwa-s5-browsers-endpoints.json';
import Page from '@/app/gcl/agwa/section5/page';
...
describe('agwa-s5-browsers-endpoints — 移行元コンテンツの全量移行', () => {
    const renderPage = () => {
