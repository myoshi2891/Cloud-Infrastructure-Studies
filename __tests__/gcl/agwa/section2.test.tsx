// __tests__/gcl/agwa/section2.test.tsx
// @vitest-environment jsdom
import { render } from '@testing-library/react';
import { describe, expect, it, vi } from 'vitest';
import inventory from '@/docs/migration-inventory/agwa-section2.json';
import Page from '@/app/gcl/agwa/section2/page';
import {
    codeBlockSelector,
    codeLineCount,
    extractBodyContent,
...
describe('agwa-section2 — 移行元コンテンツの全量移行', () => {
    const renderPage = () => {
