...
import Page from '@/app/gcl/associate-cloud-engineer/develop-your-gcp-network/page';
import { DIAGRAMS } from '@/app/gcl/associate-cloud-engineer/develop-your-gcp-network/constants';
