// __tests__/recommended-books/the-devops-handbook/page.test.tsx
// @vitest-environment jsdom
import { render } from '@testing-library/react';
import { describe, expect, it, vi } from 'vitest';
import inventory from '@/docs/migration-inventory/the-devops-handbook.json';
import Page from '@/app/recommended-books/the-devops-handbook/page';
import {
    codeBlockSelector,
    codeLineCount,
    extractBodyContent,
...
describe('the-devops-handbook — 移行元コンテンツの全量移行', () => {
    const renderPage = () => {
