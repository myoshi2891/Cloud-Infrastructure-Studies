// __tests__/recommended-books/site-reliability-engineering/page.test.tsx
// @vitest-environment jsdom
import { render } from '@testing-library/react';
import { describe, expect, it, vi } from 'vitest';
import inventory from '@/docs/migration-inventory/site-reliability-engineering.json';
...
describe('site-reliability-engineering — 移行元コンテンツの全量移行', () => {
    const renderPage = () => {
