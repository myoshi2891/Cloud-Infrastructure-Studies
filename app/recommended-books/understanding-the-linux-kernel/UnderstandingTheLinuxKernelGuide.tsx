...
{" "}
<ul><li>{" "}原典ページ:{" "}<a href="https://www.oreilly.com/library/view/understanding-the-linux/0596005652/">https://www.oreilly.com/library/view/understanding-the-linux/0596005652/</a>{" "}</li></ul>
{" "}
...
<hr />
{" "}
<h2 id="第0部osカーネルの基礎知識">第0部：OS・カーネルの基礎知識</h2>
{" "}
<p>本編に入る前に、「OS」「カーネル」という言葉が指すものを整理します。</p>
{" "}
<h3 id="01-オペレーティングシステムとカーネルの違い">{" "}0.1 オペレーティングシステムとカーネルの違い{" "}</h3>
{" "}
...
{" "}
<h3 id="02-モノリシックカーネル-vs-マイクロカーネル">{" "}0.2 モノリシックカーネル vs マイクロカーネル{" "}</h3>
{" "}
...
{" "}
<h3 id="03-プロセスカーネルモデルprocesskernel-model">{" "}0.3 プロセス／カーネルモデル（Process/Kernel Model）{" "}</h3>
{" "}
...
<Diagram id="diag-2" />
{" "}
<h3 id="04-リエントラント再入可能カーネル">{" "}0.4 リエントラント（再入可能）カーネル{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第1部序論-linuxカーネルとは何か原著-ch1-introduction">{" "}第1部：序論 ― Linuxカーネルとは何か（原著 Ch.1 Introduction）{" "}</h2>
{" "}
<h3 id="11-linuxとunix系カーネルの関係">1.1 LinuxとUnix系カーネルの関係</h3>
{" "}
...
{" "}
<h3 id="12-ハードウェア依存性">1.2 ハードウェア依存性</h3>
{" "}
...
{" "}
<h3 id="13-linuxのバージョニング">1.3 Linuxのバージョニング</h3>
{" "}
...
{" "}
<h3 id="14-基本的なosの概念">1.4 基本的なOSの概念</h3>
{" "}
<p>原著1.4節の内容を整理します。</p>
{" "}
...
{" "}
<h3 id="15-unixファイルシステムの概観">1.5 Unixファイルシステムの概観</h3>
{" "}
...
<Diagram id="diag-4" />
{" "}
<h3 id="16-unixカーネルの概観">1.6 Unixカーネルの概観</h3>
{" "}
...
<hr />
{" "}
<h2 id="第2部メモリアドレッシング原著-ch2-memory-addressing">{" "}第2部：メモリアドレッシング（原著 Ch.2 Memory Addressing）{" "}</h2>
{" "}
<h3 id="21-メモリアドレスの3つの顔">2.1 メモリアドレスの3つの顔</h3>
{" "}
...
<Diagram id="diag-5" />
{" "}
<h3 id="2223-ハードウェアのセグメンテーションとlinuxでの利用">{" "}2.2〜2.3 ハードウェアのセグメンテーションとLinuxでの利用{" "}</h3>
{" "}
...
{" "}
<h3 id="2425-ページング機構">2.4〜2.5 ページング機構</h3>
{" "}
...
{" "}
<h3 id="25-linuxにおけるページング詳細">2.5 Linuxにおけるページング詳細</h3>
{" "}
...
{" "}
<h3 id="26-ハードウェアキャッシュとメモリ階層">{" "}2.6 ハードウェアキャッシュとメモリ階層{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第3部プロセス原著-ch3-processes">第3部：プロセス（原著 Ch.3 Processes）</h2>
{" "}
<h3 id="31-プロセス軽量プロセススレッド">3.1 プロセス、軽量プロセス、スレッド</h3>
{" "}
...
<Diagram id="diag-7" />
{" "}
<h3 id="32-プロセスディスクリプタ">3.2 プロセスディスクリプタ</h3>
{" "}
...
{" "}
<h3 id="33-プロセス切り替えコンテキストスイッチ">{" "}3.3 プロセス切り替え（コンテキストスイッチ）{" "}</h3>
{" "}
...
<Diagram id="diag-9" />
{" "}
<h3 id="34-プロセスの生成">3.4 プロセスの生成</h3>
{" "}
...
{" "}
<h3 id="35-プロセスの終了">3.5 プロセスの終了</h3>
{" "}
...
<hr />
{" "}
<h2 id="第4部割り込みと例外原著-ch4-interrupts-and-exceptions">{" "}第4部：割り込みと例外（原著 Ch.4 Interrupts and Exceptions）{" "}</h2>
{" "}
<h3 id="4142-割り込みシグナルの役割">4.1〜4.2 割り込みシグナルの役割</h3>
{" "}
...
<Diagram id="diag-10" />
{" "}
<h3 id="4345-idtと例外ハンドリング">4.3〜4.5 IDTと例外ハンドリング</h3>
{" "}
...
{" "}
<h3 id="4647-割り込みハンドリングとsoftirqtasklet">{" "}4.6〜4.7 割り込みハンドリングとSoftirq/Tasklet{" "}</h3>
{" "}
...
{" "}
<h3 id="49-割り込み例外からの復帰">4.9 割り込み・例外からの復帰</h3>
{" "}
...
<hr />
{" "}
<h2 id="第5部カーネル同期原著-ch5-kernel-synchronization">{" "}第5部：カーネル同期（原著 Ch.5 Kernel Synchronization）{" "}</h2>
{" "}
<h3 id="51-なぜ同期が必要か">5.1 なぜ同期が必要か</h3>
{" "}
...
{" "}
<h3 id="52-同期プリミティブ">5.2 同期プリミティブ</h3>
{" "}
...
<Diagram id="diag-12" />
{" "}
<h3 id="rcuread-copy-updateの考え方">RCU（Read-Copy-Update）の考え方</h3>
{" "}
...
{" "}
<h3 id="5354-使い分けと典型的な保護パターン">{" "}5.3〜5.4 使い分けと典型的な保護パターン{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第6部タイミング計測原著-ch6-timing-measurements">{" "}第6部：タイミング計測（原著 Ch.6 Timing Measurements）{" "}</h2>
{" "}
<h3 id="61-クロックとタイマー回路">6.1 クロックとタイマー回路</h3>
{" "}
...
{" "}
<h3 id="62-linuxのタイムキーピングアーキテクチャ">{" "}6.2 Linuxのタイムキーピングアーキテクチャ{" "}</h3>
{" "}
...
<Diagram id="diag-14" />
{" "}
<h3 id="6366-時刻更新統計ソフトウェアタイマー">{" "}6.3〜6.6 時刻更新・統計・ソフトウェアタイマー{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第7部プロセススケジューリング原著-ch7-process-scheduling">{" "}第7部：プロセススケジューリング（原著 Ch.7 Process Scheduling）{" "}</h2>
{" "}
<h3 id="7172-スケジューリングポリシー">7.1〜7.2 スケジューリングポリシー</h3>
{" "}
...
{" "}
<h3 id="cfsの考え方原著執筆後に主流化した設計">{" "}CFSの考え方（原著執筆後に主流化した設計）{" "}</h3>
{" "}
...
{" "}
<h3 id="7374-スケジューラが使うデータ構造と関数">{" "}7.3〜7.4 スケジューラが使うデータ構造と関数{" "}</h3>
{" "}
...
{" "}
<h3 id="75-マルチプロセッサでの負荷分散">7.5 マルチプロセッサでの負荷分散</h3>
{" "}
...
{" "}
<h3 id="2024年以降sched_extebpfで作るカスタムスケジューラ">{" "}2024年以降：sched_ext（eBPFで作るカスタムスケジューラ）{" "}</h3>
{" "}
...
{" "}
<h3 id="76-スケジューリング関連のシステムコール">{" "}7.6 スケジューリング関連のシステムコール{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第8部メモリ管理原著-ch8-memory-management">{" "}第8部：メモリ管理（原著 Ch.8 Memory Management）{" "}</h2>
{" "}
<h3 id="81-ページフレーム管理">8.1 ページフレーム管理</h3>
{" "}
...
{" "}
<h3 id="83-非連続メモリ領域vmalloc">8.3 非連続メモリ領域（vmalloc）</h3>
{" "}
...
<hr />
{" "}
<h2 id="第9部プロセスアドレス空間原著-ch9-process-address-space">{" "}第9部：プロセスアドレス空間（原著 Ch.9 Process Address Space）{" "}</h2>
{" "}
<h3 id="9192-プロセスのアドレス空間とメモリディスクリプタ">{" "}9.1〜9.2 プロセスのアドレス空間とメモリディスクリプタ{" "}</h3>
{" "}
...
{" "}
<h3 id="93-メモリ領域vma-virtual-memory-area">{" "}9.3 メモリ領域（VMA: Virtual Memory Area）{" "}</h3>
{" "}
...
{" "}
<h3 id="94-ページフォルト例外ハンドラ">9.4 ページフォルト例外ハンドラ</h3>
{" "}
...
{" "}
<h3 id="9596-アドレス空間の生成削除とヒープ管理">{" "}9.5〜9.6 アドレス空間の生成・削除とヒープ管理{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第10部システムコール原著-ch10-system-calls">{" "}第10部：システムコール（原著 Ch.10 System Calls）{" "}</h2>
{" "}
<h3 id="101102-posix-apiとシステムコールハンドラ">{" "}10.1〜10.2 POSIX APIとシステムコールハンドラ{" "}</h3>
{" "}
...
{" "}
<h3 id="103-システムコールの発行終了">10.3 システムコールの発行・終了</h3>
{" "}
...
{" "}
<h3 id="104-パラメータの受け渡しと検証">10.4 パラメータの受け渡しと検証</h3>
{" "}
...
{" "}
<h3 id="105-カーネルラッパールーチン">10.5 カーネルラッパールーチン</h3>
{" "}
<p>{" "}多くのシステムコールは、アーキテクチャ非依存の実処理関数（<code>sys_read()</code>{" "}など）と、アーキテクチャ依存の薄いラッパー（レジスタからの引数取り出しなど）に分離されています。{" "}</p>
{" "}
<hr />
{" "}
<h2 id="第11部シグナル原著-ch11-signals">第11部：シグナル（原著 Ch.11 Signals）</h2>
{" "}
<h3 id="111-シグナルの役割">11.1 シグナルの役割</h3>
{" "}
...
{" "}
<h3 id="112113-シグナルの生成と配送">11.2〜11.3 シグナルの生成と配送</h3>
{" "}
<Diagram id="diag-22" />
{" "}
...
{" "}
<h3 id="システムコールの再実行">システムコールの再実行</h3>
{" "}
...
{" "}
<h3 id="114-シグナル関連のシステムコール">11.4 シグナル関連のシステムコール</h3>
{" "}
...
<hr />
{" "}
<h2 id="第12部仮想ファイルシステムvfs原著-ch12-the-virtual-filesystem">{" "}第12部：仮想ファイルシステム（VFS）（原著 Ch.12 The Virtual Filesystem）{" "}</h2>
{" "}
<h3 id="121-vfsの役割">12.1 VFSの役割</h3>
{" "}
...
<Diagram id="diag-23" />
{" "}
<h3 id="122-vfsの4大オブジェクト">12.2 VFSの4大オブジェクト</h3>
{" "}
...
{" "}
<h3 id="123124-ファイルシステムの種類とマウント">{" "}12.3〜12.4 ファイルシステムの種類とマウント{" "}</h3>
{" "}
...
{" "}
<h3 id="125-パス名の探索pathname-lookup">12.5 パス名の探索（Pathname Lookup）</h3>
{" "}
...
{" "}
<h3 id="126127-vfsシステムコールの実装とファイルロック">{" "}12.6〜12.7 VFSシステムコールの実装とファイルロック{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第13部ioアーキテクチャとデバイスドライバ原著-ch13-io-architecture-and-device-drivers">{" "}第13部：I/Oアーキテクチャとデバイスドライバ（原著 Ch.13 I/O Architecture and Device Drivers）{" "}</h2>
{" "}
<h3 id="131-ioアーキテクチャ">13.1 I/Oアーキテクチャ</h3>
{" "}
...
{" "}
<h3 id="132-デバイスドライバモデル">13.2 デバイスドライバモデル</h3>
{" "}
...
{" "}
<h3 id="133-デバイスファイル">13.3 デバイスファイル</h3>
{" "}
...
{" "}
<h3 id="134135-デバイスドライバの実装">13.4〜13.5 デバイスドライバの実装</h3>
{" "}
...
<hr />
{" "}
<h2 id="第14部ブロックデバイスドライバ原著-ch14-block-device-drivers">{" "}第14部：ブロックデバイスドライバ（原著 Ch.14 Block Device Drivers）{" "}</h2>
{" "}
<h3 id="141142-ブロックデバイスの扱いとジェネリックブロック層">{" "}14.1〜14.2 ブロックデバイスの扱いとジェネリックブロック層{" "}</h3>
{" "}
...
{" "}
<h3 id="143-ioスケジューラ">14.3 I/Oスケジューラ</h3>
{" "}
...
{" "}
<h3 id="144145-ブロックデバイスドライバの登録と初期化">{" "}14.4〜14.5 ブロックデバイスドライバの登録と初期化{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第15部ページキャッシュ原著-ch15-the-page-cache">{" "}第15部：ページキャッシュ（原著 Ch.15 The Page Cache）{" "}</h2>
{" "}
<h3 id="151-ページキャッシュとは">15.1 ページキャッシュとは</h3>
{" "}
...
<Diagram id="diag-29" />
{" "}
<h3 id="152-ブロックのページキャッシュ格納">15.2 ブロックのページキャッシュ格納</h3>
{" "}
...
{" "}
<h3 id="153-ダーティページの書き戻し">15.3 ダーティページの書き戻し</h3>
{" "}
...
<Diagram id="diag-30" />
{" "}
<h3 id="154-syncfsyncfdatasync">15.4 sync()、fsync()、fdatasync()</h3>
{" "}
...
<hr />
{" "}
<h2 id="第16部ファイルアクセス原著-ch16-accessing-files">{" "}第16部：ファイルアクセス（原著 Ch.16 Accessing Files）{" "}</h2>
{" "}
<h3 id="161-ファイルの読み書き">16.1 ファイルの読み書き</h3>
{" "}
...
{" "}
<h3 id="162-メモリマッピングmmap">16.2 メモリマッピング（mmap）</h3>
{" "}
...
{" "}
<h3 id="163164-ダイレクトioと非同期io">16.3〜16.4 ダイレクトI/Oと非同期I/O</h3>
{" "}
...
{" "}
<h3 id="2019年以降io_uringによる非同期ioの刷新">{" "}2019年以降：io_uringによる非同期I/Oの刷新{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第17部ページフレーム回収原著-ch17-page-frame-reclaiming">{" "}第17部：ページフレーム回収（原著 Ch.17 Page Frame Reclaiming）{" "}</h2>
{" "}
<h3 id="171-ページフレーム回収アルゴリズムpfra">{" "}17.1 ページフレーム回収アルゴリズム（PFRA）{" "}</h3>
{" "}
...
{" "}
<h3 id="172-逆マッピングreverse-mapping">17.2 逆マッピング（Reverse Mapping）</h3>
{" "}
...
{" "}
<h3 id="173-pfraの実装lruリスト">17.3 PFRAの実装：LRUリスト</h3>
{" "}
...
{" "}
<h3 id="oom-killerout-of-memory-killer">OOM Killer（Out Of Memory Killer）</h3>
{" "}
...
{" "}
<h3 id="174-スワッピング">17.4 スワッピング</h3>
{" "}
...
<hr />
{" "}
<h2 id="第18部ext2ext3から現代のファイルシステムへ原著-ch18-the-ext2-and-ext3-filesystems">{" "}第18部：Ext2/Ext3から現代のファイルシステムへ（原著 Ch.18 The Ext2 and Ext3 Filesystems）{" "}</h2>
{" "}
<h3 id="181183-ext2の設計">18.1〜18.3 Ext2の設計</h3>
{" "}
...
{" "}
<h3 id="187-ext3とジャーナリング">18.7 Ext3とジャーナリング</h3>
{" "}
...
{" "}
<h3 id="2005年から2026年へlinuxファイルシステムの系譜">{" "}2005年から2026年へ：Linuxファイルシステムの系譜{" "}</h3>
{" "}
...
{" "}
<h3 id="コラムbcachefsを巡る顛末が示すlinuxカーネル開発の統治構造">{" "}コラム：bcachefsを巡る顛末が示すLinuxカーネル開発の統治構造{" "}</h3>
{" "}
...
<hr />
{" "}
<h2 id="第19部プロセス間通信ipc原著-ch19-process-communication">{" "}第19部：プロセス間通信（IPC）（原著 Ch.19 Process Communication）{" "}</h2>
{" "}
<h3 id="191-パイプ">19.1 パイプ</h3>
{" "}
...
{" "}
<h3 id="194-posix-メッセージキュー">19.4 POSIX メッセージキュー</h3>
{" "}
...
<hr />
{" "}
<h2 id="第20部プログラム実行原著-ch20-program-execution">{" "}第20部：プログラム実行（原著 Ch.20 Program Execution）{" "}</h2>
{" "}
<h3 id="201-実行可能ファイル">20.1 実行可能ファイル</h3>
{" "}
...
{" "}
<h3 id="202-実行可能フォーマット">20.2 実行可能フォーマット</h3>
{" "}
...
<Diagram id="diag-39" />
{" "}
<h3 id="203-実行ドメイン">20.3 実行ドメイン</h3>
{" "}
...
{" "}
<h3 id="204-execファミリー関数">20.4 execファミリー関数</h3>
{" "}
...
<hr />
{" "}
<h2 id="第21部システム起動とモジュール原著-appendix-ab">{" "}第21部：システム起動とモジュール（原著 Appendix A/B）{" "}</h2>
{" "}
<h3 id="a-システム起動">A. システム起動</h3>
{" "}
...
<hr />
{" "}
<h2 id="第22部2026年最新動向-原著から20年カーネルはどう変わったか">{" "}第22部：2026年最新動向 ― 原著から20年、カーネルはどう変わったか{" "}</h2>
{" "}
...
{" "}
<h3 id="221-現在のバージョニング状況2026年8月時点">{" "}22.1 現在のバージョニング状況（2026年8月時点）{" "}</h3>
{" "}
...
{" "}
<h3 id="222-スケジューラの進化o1-cfs-eevdf-sched_ext">{" "}22.2 スケジューラの進化：O(1) → CFS → EEVDF → sched_ext{" "}</h3>
{" "}
...
{" "}
<h3 id="223-rust-for-linuxc言語一辺倒からの転換">{" "}22.3 Rust for Linux：C言語一辺倒からの転換{" "}</h3>
{" "}
...
{" "}
<h3 id="224-ebpfカーネルをプログラム可能にする技術">{" "}22.4 eBPF：カーネルを「プログラム可能」にする技術{" "}</h3>
{" "}
...
{" "}
<h3 id="225-コンテナ技術を支える-namespaces-と-cgroups">{" "}22.5 コンテナ技術を支える namespaces と cgroups{" "}</h3>
{" "}
...
<hr />
{" "}
<h3 id="226-rcuのその後カーネル全体への浸透">{" "}22.6 RCUのその後：カーネル全体への浸透{" "}</h3>
{" "}
...
{" "}
<h3 id="227-そのままと変わったものの整理">{" "}22.7 「そのまま」と「変わったもの」の整理{" "}</h3>
{" "}
...
{" "}
<h3 id="228-カーネル開発コミュニティとガバナンス">{" "}22.8 カーネル開発コミュニティとガバナンス{" "}</h3>
{" "}
...
<Diagram id="diag-45" />
{" "}
<h3 id="おすすめの実践コマンド">おすすめの実践コマンド</h3>
{" "}
...
{" "}
<h2 id="チェックリストこのガイドで押さえておきたい理解ポイント">{" "}チェックリスト：このガイドで押さえておきたい理解ポイント{" "}</h2>
{" "}
...
{" "}
<h3 id="カーネルバージョンリリース管理">カーネルバージョン・リリース管理</h3>
{" "}
...
{" "}
<h3 id="プロセススケジューラo1cfseevdfsched_ext">{" "}プロセススケジューラ（O(1)→CFS→EEVDF→sched_ext）{" "}</h3>
{" "}
...
{" "}
<h3 id="rust-for-linux">Rust for Linux</h3>
{" "}
...
{" "}
<h3 id="非同期ioio_uring">非同期I/O（io_uring）</h3>
{" "}
...
{" "}
<h3 id="ebpf-sched_ext">eBPF / sched_ext</h3>
{" "}
...
{" "}
<h3 id="ファイルシステムbcachefsを巡る経緯を含む">{" "}ファイルシステム（bcachefsを巡る経緯を含む）{" "}</h3>
{" "}
...
{" "}
<h3 id="さらに学ぶために関連書籍">さらに学ぶために（関連書籍）</h3>
{" "}
