...
export const DIAGRAM_LABELS: Record<DiagramId, string> = {
    ...
    "diag-3": "systemdユニットの依存関係イメージ（例: Webサーバー）",
    "diag-4": "sudoによる権限昇格の流れ",
    "diag-5": "sudoによる権限昇格の流れ",
    "diag-6": "sudoによる権限昇格の流れ",
    "diag-7": "sudoによる権限昇格の流れ",
    "diag-8": "sudoによる権限昇格の流れ",
    "diag-9": "sudoによる権限昇格の流れ",
    "diag-10": "sudoによる権限昇格の流れ",
    "diag-11": "sudoによる権限昇格の流れ",
    "diag-12": "sudoによる権限昇格の流れ",
    "diag-13": "sudoによる権限昇格の流れ",
    "diag-14": "sudoによる権限昇格の流れ",
    "diag-15": "sudoによる権限昇格の流れ",
    "diag-16": "sudoによる権限昇格の流れ",
    "diag-17": "sudoによる権限昇格の流れ",
    "diag-18": "sudoによる権限昇格の流れ",
    "diag-19": "LVMの3層構造",
    "diag-20": "ファイルシステム選定の目安",
    "diag-21": "ファイルシステム選定の目安",
    "diag-22": "ファイルシステム選定の目安",
    "diag-23": "ファイルシステム選定の目安",
    "diag-24": "ファイルシステム選定の目安",
    "diag-25": "ファイルシステム選定の目安",
    "diag-26": "SSHハードニングのチェックリスト（/etc/ssh/sshd_config）",
    "diag-27": "SSHハードニングのチェックリスト（/etc/ssh/sshd_config）",
    "diag-28": "SSHハードニングのチェックリスト（/etc/ssh/sshd_config）",
    "diag-29": "SSHハードニングのチェックリスト（/etc/ssh/sshd_config）"
};
