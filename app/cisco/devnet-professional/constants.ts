export const DIAGRAMS = {
  levels: `flowchart TB
    ...
    subgraph ProfPath["CCNP Automation 認定までの流れ"]
        direction TB
        CoreExam["コア試験に合格<br/>350-901 AUTOCOR"] --> CoreSpecialist["自動的に付与:<br/>Cisco Certified Automation Specialist - Core"]
        ConcExam["コンセントレーション試験に合格<br/>専門分野を1つ選択"] --> ConcSpecialist["自動的に付与:<br/>Cisco Certified Automation Specialist - Enterprise Automation and Programmability<br/>または<br/>Cisco Certified Automation Specialist - Data Center Automation and Programmability"]
  ...
  mechanism: `flowchart TB
    ...
    subgraph Concentrations["コンセントレーション試験（いずれか1つに合格・すべて90分）"]
        direction TB
        C1["300-435 ENAUTO<br/>Cisco Certified Automation Specialist - Enterprise Automation and Programmability"]
        C2["300-635 DCNAUTO<br/>Cisco Certified Automation Specialist - Data Center Automation and Programmability"]
    end
  ...
  roadmap: `flowchart TB
    ...
    S4["Step 4<br/>コア試験(AUTOCOR)に合格する<br/>→ Cisco Certified Automation Specialist - Core 認定を取得"] --> S5
    S5["Step 5<br/>自分の専門分野に合う<br/>コンセントレーション試験を1つ選ぶ"] --> S6
    S6["Step 6<br/>選んだコンセントレーション試験に合格する<br/>→ Cisco Certified Automation Specialist - Enterprise Automation and Programmability<br/>または Cisco Certified Automation Specialist - Data Center Automation and Programmability 認定を取得"] --> S7
