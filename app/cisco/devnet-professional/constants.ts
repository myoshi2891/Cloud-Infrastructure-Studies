export const DIAGRAMS = {
  levels: `flowchart TB
    ...
    subgraph ProfPath["CCNP Automation 認定までの流れ"]
        direction TB
        CoreExam["コア試験に合格<br/>350-901 AUTOCOR"] --> CoreSpecialist["自動的に付与:<br/>Automation Specialist - Core"]
        ConcExam["コンセントレーション試験に合格<br/>専門分野を1つ選択"] --> ConcSpecialist["自動的に付与:<br/>Automation Specialist - 専門分野"]
  ...
  mechanism: `flowchart TB
    ...
    subgraph Concentrations["コンセントレーション試験（いずれか1つに合格・すべて90分）"]
        ...
        C2["300-635 DCNAUTO<br/>データセンター自動化"]
    end
  ...
  roadmap: `flowchart TB
    ...
    S4["Step 4<br/>コア試験(AUTOCOR)に合格する<br/>→ Specialist - Core 認定を取得"] --> S5
