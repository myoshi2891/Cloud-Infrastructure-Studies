...
export const Section3: React.FC = () => {
    return (
        <div id="s3" className={baseStyles.sgap}>
            <div className={baseStyles.secHead}>
                <div className={`${baseStyles.secNum} ${styles.sn3}`}>03</div>
                <div className={baseStyles.secHeadTxt}>
                    <h2 className={baseStyles.secTitle}>データの種類と特性</h2>
                </div>
            </div>
            <SectionCard id="cdl-2-3" idNumber="3" title="データの種類と特性">
                <h3 className={baseStyles.stitle}>3.1 3 種類のデータ形式</h3>
                <p className={baseStyles.tdesc}>データは形式によって 3 種類に分類されます。
  ...
  非構造化データ:  約 70〜80%   ← 最も多い！`}</code></pre>
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>3.2 構造化データ（Structured Data）</h3>
...
特徴:
  ...
  ❌ 非構造化データのような柔軟な表現は難しい`}</code></pre>
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>3.3 非構造化データ（Unstructured Data）</h3>
                <h4 className="stitle mt-4">定義と特徴</h4>
                <DiagramSVG viewBox="0 0 600 200" ariaLabel="非構造化データの定義と特徴: スキーマなし、全データの70〜80%、従来は分析困難だがAI/MLで活用">
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>3.4 半構造化データ（Semi-Structured Data）</h3>
                <h4 className="stitle mt-4">定義と特徴</h4>
