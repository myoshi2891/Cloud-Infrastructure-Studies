    ...
    return (
        <div id="s6" className="sgap">
            ...
            <SectionCard id="cdl-2-6" idNumber="6" title="Google Cloud のデータベースサービス">
                ...
                <div dangerouslySetInnerHTML={{ __html: `<h3>6.1 データベース選択の全体像</h3>
<p>Google Cloud には多種多様なデータベースサービスがあります。
...
<h3>6.2 Cloud SQL（マネージドリレーショナルDB）</h3>
...
費用:
  ...
  → 本当にグローバル分散が必要な場合のみ選択`}
                ...
                <div dangerouslySetInnerHTML={{ __html: `<h4>Cloud SQL vs Cloud Spanner の比較</h4>
<table>
<thead>
<tr>
<th>比較項目</th>
...
<h3>6.4 Firestore（NoSQL ドキュメント DB）</h3>
...
<h3>6.5 Bigtable（NoSQL ワイドカラム DB）</h3>
...
Redis vs Memcached の選択:
  ...
  → 通常は Redis を選択することが多い`}
                ...
                <div dangerouslySetInnerHTML={{ __html: `<h3>6.8 AlloyDB（PostgreSQL 互換高性能 DB）</h3>
...
<a href="https://cloud.google.com/spanner/docs">https://cloud.google.com/spanner/docs</a>
<a href="https://cloud.google.com/bigquery/docs">https://cloud.google.com/bigquery/docs</a>
<a href="https://cloud.google.com/firestore/docs">https://cloud.google.com/firestore/docs</a>
<a href="https://cloud.google.com/bigtable/docs">https://cloud.google.com/bigtable/docs</a>
<a href="https://cloud.google.com/memorystore/docs">https://cloud.google.com/memorystore/docs</a>
...
<h3><strong>データベースの移行とモダナイゼーション (Database Migration)</strong></h3>
