    ...
    return (
        <div id="s5" className="sgap">
            ...
            <SectionCard id="cdl-2-5" idNumber="5" title="Google Cloud のデータストレージサービス">
                ...
                <div dangerouslySetInnerHTML={{ __html: `<h3>5.1 Cloud Storage（オブジェクトストレージ）</h3>
<h4>Cloud Storage とは</h4>
<p><strong>Cloud Storage</strong> は、あらゆる種類のファイル（オブジェクト）を
...
<h4>Cloud Storage の 4 つのストレージクラス</h4>
<p>ストレージクラスは「アクセス頻度」と「コスト」のバランスで選択します。</p>
` }} />
...
<p>※ 価格はリージョンにより異なります — 表は us-central1 の参考値です。最新情報は<a href="https://cloud.google.com/storage/pricing">公式の料金ページ</a>をご確認ください。</p>
<h4>Cloud Storage のライフサイクル管理</h4>
` }} />
...
効果: 手動管理なしでストレージコストを大幅に最適化`}
                ...
                <div dangerouslySetInnerHTML={{ __html: `<h4>✅ ベストプラクティス: Cloud Storage</h4>
...
<blockquote>
<p>📎 <strong>参照</strong>:
<a href="https://cloud.google.com/storage/docs/storage-classes">https://cloud.google.com/storage/docs/storage-classes</a>
<a href="https://cloud.google.com/storage/docs/lifecycle">https://cloud.google.com/storage/docs/lifecycle</a>
...
` }} />
            ...
            <SectionCard id="gcdl-2-5" idNumber="Deep Dive" title="オブジェクトストレージの最適化：Cloud Storage">
                ...
                <div dangerouslySetInnerHTML={{ __html: `<p><strong>2.2 Google Cloud データマネジメントソリューション</strong></p>
<p>CDL試験では、ビジネスのユースケースに応じて最適なデータ管理製品を選択する能力が求められる。これには、データベース、データウェアハウス、データレイクといった基本概念の明確な区別が含まれる 。</p>
<p>以下の表は、データ管理の主要な3つの概念の違いを明確に示したものである 。</p>
<table>
<thead>
<tr>
