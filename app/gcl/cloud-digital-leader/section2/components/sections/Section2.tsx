...
/**
 * セクション2: データとは何か？ビジネスにおけるデータの価値
 * データドリブン経営の基礎と、4 種類のデータ分析レベルについて解説します。
 * @returns JSX.Element
 */
export const Section2: React.FC = () => {
    const markerId = useId();
    return (
        <div id="s2" className={baseStyles.sgap}>
            <div className={baseStyles.secHead}>
                <div className={`${baseStyles.secNum} ${styles.sn2}`}>02</div>
                <div className={baseStyles.secHeadTxt}>
                    <h2 className={baseStyles.secTitle}>データとは何か？ビジネスにおけるデータの価値</h2>
                </div>
            </div>
            <SectionCard id="cdl-2-2" idNumber="2" title="データとは何か？ビジネスにおけるデータの価値">
                
                <h3 className={baseStyles.stitle}>2.1 「データ」の本質的な意味</h3>
                <p className={baseStyles.tdesc}><strong>データ</strong>とは、事実・数値・文字・画像・音声など、
                何らかの情報を記録したものです。
                ...
                <DiagramSVG viewBox="0 0 800 200" ariaLabel="データから意思決定への流れを示す図: データ、情報、知識、知恵、意思決定">
                    ...
                    <path d="M 140 30 L 160 30" stroke="currentColor" markerEnd={`url(#${markerId})`} />
                    ...
                    <path d="M 300 30 L 320 30" stroke="currentColor" markerEnd={`url(#${markerId})`} />
                    ...
                    <path d="M 460 30 L 480 30" stroke="currentColor" markerEnd={`url(#${markerId})`} />
                    ...
                    <path d="M 620 30 L 640 30" stroke="currentColor" markerEnd={`url(#${markerId})`} />
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>2.2 データドリブン経営とは</h3>
                <p className={baseStyles.tdesc}><strong>データドリブン経営</strong>とは、経験・勘・感覚ではなく、
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>2.3 データが生み出す 4 種類のビジネス価値</h3>
                <p className={baseStyles.tdesc}>データ分析には4つのレベルがあります。
                上位レベルほど高い価値を生み出しますが、より高度な技術が必要です。</p>

                <DiagramSVG viewBox="0 0 600 240" ariaLabel="データ分析の4レベル図: 記述的・診断的・予測的・処方的分析を価値と複雑さの軸で示す">
                ...
                <blockquote className="sec-quote">
                    <p className={baseStyles.tdesc}>📎 <strong>参照</strong>: Google Cloud データ分析ソリューション<br/>
            ...
            <SectionCard id="gcdl-2-2" idNumber="Deep Dive" title="データの価値 (The Value of Data)">
                <h3 className={baseStyles.stitle}>Google Cloud Digital Leader: セクション 2「データ トランスフォーメーションの探求」完全解説レポート</h3>
                <h4 className="stitle mt-4">はじめに：データトランスフォーメーションとクラウドのパラダイムシフト</h4>
                <p className={baseStyles.tdesc}>現代のエンタープライズビジネスにおいて、データは単なる記録の蓄積から、組織の競争優位性を決定づける中核的な戦略資産へと進化を遂げている。Google Cloud Digital Leader（CDL）認定試験は、クラウドテクノロジーの基礎と、Google Cloudのコア製品が組織の目標達成にどのように貢献するかを実証するための資格である。<br/>
