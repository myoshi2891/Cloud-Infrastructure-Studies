    ...
    return (
        <div id="s10" className="sgap">
            ...
            <SectionCard id="cdl-2-10" idNumber="10" title="Google Cloud のデータガバナンスとセキュリティ">
                <h3 className="stitle">10.1 データガバナンスとは</h3>
                <p className="tdesc"><strong>データガバナンス</strong>とは、組織のデータを
                ...
                <h3 className="stitle mt-6">10.2 Dataplex（データ管理・ガバナンス基盤）</h3>
...
主な機能:
  ...
  4. セキュリティポリシーの一元管理`}</code></pre>
                ...
                <h3 className="stitle mt-6">10.3 Dataplex Universal Catalog（BigQuery Universal Catalog）</h3>
                ...
                <h3 className="stitle mt-6">10.5 データのプライバシー保護技術（試験頻出）</h3>
                <p className="tdesc">試験でよく問われる 3 つのプライバシー保護手法の違いを理解することが重要です。</p>
                ...
                <h3 className="stitle mt-6">10.6 データのアクセス制御</h3>
