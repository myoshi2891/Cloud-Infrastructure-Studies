...
export const Section10: React.FC = () => {
    return (
        <div id="s10" className={baseStyles.sgap}>
            <div className={baseStyles.secHead}>
                <div className={`${baseStyles.secNum} ${styles.sn10}`}>10</div>
                <div className={baseStyles.secHeadTxt}>
                    <h2 className={baseStyles.secTitle}>Google Cloud のデータガバナンスとセキュリティ</h2>
                </div>
            </div>
            <SectionCard id="cdl-2-10" idNumber="10" title="Google Cloud のデータガバナンスとセキュリティ">
                <h3 className={baseStyles.stitle}>10.1 データガバナンスとは</h3>
                <p className={baseStyles.tdesc}><strong>データガバナンス</strong>とは、組織のデータを
                正確・安全・効率的に管理するための仕組み・プロセス・ポリシーです。</p>

                <DiagramSVG viewBox="0 0 700 240" ariaLabel="データガバナンスの必要性図: データ品質・所在不明・個人情報漏洩・不正アクセスの問題と、データカタログ・データ系譜・アクセス制御による解決策">
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>10.2 Dataplex（データ管理・ガバナンス基盤）</h3>
...
主な機能:
  ...
  4. セキュリティポリシーの一元管理`}</code></pre>
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>10.3 Dataplex Universal Catalog（BigQuery Universal Catalog）</h3>
                <DiagramSVG viewBox="0 0 700 220" ariaLabel="Dataplex Universal Catalog 図: 組織内の全データアセットを検索・管理。購買データを検索すると BigQuery テーブルが発見され IAM ポリシーでアクセス申請が可能">
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>10.4 Sensitive Data Protection（機密データ保護）</h3>
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>10.5 データのプライバシー保護技術（試験頻出）</h3>
                <p className={baseStyles.tdesc}>試験でよく問われる 3 つのプライバシー保護手法の違いを理解することが重要です。</p>

                <DiagramSVG viewBox="0 0 700 240" ariaLabel="プライバシー保護技術比較図: ①匿名化（再識別不可、GDPR対象外）、②仮名化（変換テーブルがあれば再識別可能、GDPR対象）、③差分プライバシー（統計的ノイズで個人情報保護）">
                    <rect x="10" y="10" width="680" height="220" rx="8" strokeWidth="2" stroke="var(--color-primary, currentColor)" fill="var(--color-background, transparent)" />
                ...
                <h3 className={`${baseStyles.stitle} mt-6`}>10.6 データのアクセス制御</h3>
