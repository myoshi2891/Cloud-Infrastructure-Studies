                ...
                <div className={baseStyles.grid3}>
                    <div className={`${baseStyles.card} border-t-[3px] border-[var(--color-accent-blue)]`}>
                        ...
                        <div className="mt-4">
                            ...
                            <span className={`${baseStyles.badge} ${baseStyles.badgeTeal} ml-1`}>ビジネス価値</span>
                        </div>
                    </div>
                    ...
                    <div className={`${baseStyles.card} border-t-[3px] border-[var(--color-accent-cyan)]`}>
                        ...
                        <div className="mt-4">
                            ...
                            <span className={`${baseStyles.badge} ${baseStyles.badgeYellow} ml-1`}>トレードオフ</span>
                        </div>
                    </div>
                    ...
                    <div className={`${baseStyles.card} border-t-[3px] border-[var(--color-accent-green)]`}>
                        ...
                        <div className="mt-4">
                            ...
                            <span className={`${baseStyles.badge} ${baseStyles.badgePurple} ml-1`}>各サービス</span>
                        </div>
                    </div>
                </div>

                <div className={`${baseStyles.infoBox} mt-8`}>
