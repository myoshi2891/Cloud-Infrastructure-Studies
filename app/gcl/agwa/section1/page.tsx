        ...
        <>
                ...
                <section id="ch1" className="chapter">
                    ...
                    >
                        ...
                        <ul className="bp-list">
                            ...
                            <li>
                                削除後 20 日を過ぎたデータは復元不可。退職者データ保持にはアーカイブユーザー (AU)
                                ライセンスを活用し、コストとコンプライアンスを両立させる
                            </li>
                            <li>
                                SAML SSO 導入時もスーパー管理者アカウントは SSO 対象外とし、IdP 障害時の管理者ロックアウトを防止する
                            </li>
                            <li>
                                特権管理者（スーパー管理者）は最小人数に絞り、2 段階認証 (2SV) を必須とする
                            </li>
                        </ul>
                        </div>
                        </section>
            ...
            <section id="ch5" className="chapter">
                ...
                >
                    ...
                    <ul className="bp-list">
                        <li>
                            すべての建物に正確な住所情報を登録し、ユーザーが場所を特定しやすくする
                        </li>
                        <li>
                            フィーチャー（設備）を標準化して定義し、ユーザーがカレンダーで「モニターのある会議室」を簡単に絞り込めるようにする
                        </li>
                        <li>
                            リソース名に規則性を持たせる（例：<code>Tokyo-HQ-10F-RoomA</code>）ことで視認性を高める
                        </li>
                        <li>
                            リソースのカレンダー共有設定を適切に管理し、意図しない予約変更を防ぐ
                        </li>
                        <li>
                            定期的にリソースの利用状況をレビューし、不足しているフロアや設備を特定して改善に繋げる
                        </li>
                    </ul>
                </div>
            </section>
