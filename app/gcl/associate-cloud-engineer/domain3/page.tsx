...
function Chapter18() {
    return (
        <div id="ch18" className="sgap">
            <div className="sec-head">
                <div className="sec-num sn18">18</div>
                <div className="sec-head-txt">
            ...
            <div className="tcard">
                <div className="ttitle">
                    <span className="tid">18.1</span>公式ドキュメント（Official Documentation）
                </div>
                <div className="tgrid">
                    {[
            ...
            <div className="tcard">
                <div className="ttitle">
                    <span className="tid">18.2</span>技術解説・コミュニティリソース（Tech Guides & Community）
                </div>
                <div className="tgrid">
                    {[
