...
このプラクティスは、Robert C. Martin（Uncle Bob）の『Clean Code』や Miško Hevery の「テスタビリティのためのコード」といった考え方へのオマージュとして、著者が独自に提唱した **CLEAN** という頭字語で整理されています。5つの性質を1語で思い出せるため、コードレビューや設計判断のチェックリストとして使いやすい形にまとめられています。
