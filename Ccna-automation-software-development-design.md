...
1. [この認定と試験について](#1-この認定と試験について)
2. [試験全体のドメイン構成](#2-試験全体のドメイン構成)
3. [1.1 データフォーマットの比較（XML / JSON / YAML）](#3-11-データフォーマットの比較xml--json--yaml)
4. [1.2 データフォーマットをPythonのデータ構造にパースする](#4-12-データフォーマットをpythonのデータ構造にパースする)
5. [1.3 テスト駆動開発（TDD）の概念](#5-13-テスト駆動開発tddの概念)
6. [1.4 ソフトウェア開発手法の比較（Agile / Lean / Waterfall）](#6-14-ソフトウェア開発手法の比較agile--lean--waterfall)
7. [1.5 コードを関数・クラス・モジュールに整理する利点](#7-15-コードを関数クラスモジュールに整理する利点)
8. [1.6 代表的なデザインパターン（MVCとObserver）](#8-16-代表的なデザインパターンmvcとobserver)
9. [1.7 バージョン管理の利点](#9-17-バージョン管理の利点)
10. [1.8 Gitの基本操作](#10-18-gitの基本操作)
11. [実践シナリオでつなげて理解する](#11-実践シナリオでつなげて理解する)
12. [学習チェックリスト・理解度クイズ](#12-学習チェックリスト理解度クイズ)
13. [参考ソース](#13-参考ソース)
...
- REST API（ドメイン2.0で詳しく学習）のやり取りは**JSON**が主流
- Ansibleの設定ファイルやCisco NSOのモデルは**YAML**が主流
- 古いSOAPベースのAPIや一部のネットワーク機器の設定エクスポートには**XML**が使われることがある
