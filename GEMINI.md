...
- `/app`: Next.js App Router のページコンポーネント。
  - /app/gcl/associate-cloud-engineer: ACE 試験対策ページ（domain1〜4、section1、section2、section3、architecture-guide、complete-advanced-guide、cloud-load-balancing-guide、develop-your-gcp-network、build-a-secure-google-cloud-network、hands-on/set-up-an-app-dev-environment-on-google-cloud を含む）。
