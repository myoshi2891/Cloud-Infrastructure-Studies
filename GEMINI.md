...
- `/app`: Next.js App Router のページコンポーネント。
  ...
  - `/app/gcl/professional-cloud-architect`: Professional Cloud Architect（PCA）試験 完全対策ガイド（`section1-design-planning`、`section2-managing-provisioning`、`section3-security-compliance`、`section4-process-optimization`、`section5-managing-implementation` 完全ガイド含む）。
