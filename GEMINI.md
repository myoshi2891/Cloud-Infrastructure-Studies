...
- `/app`: Next.js App Router のページコンポーネント。
  - /app/gcl/associate-cloud-engineer: ACE 試験対策ページ（domain1〜4、section1、section2、section3、architecture-guide、complete-advanced-guide、cloud-load-balancing-guide を含む）。
