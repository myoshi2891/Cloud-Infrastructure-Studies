...
- `/app`: Next.js App Router のページコンポーネント。
  ...
  - `/app/aws/solutions-architect-associate`: AWS Certified Solutions Architect – Associate (SAA-C03) 完全対策ガイド。
...
- AWS: `app/aws/` 配下（`solutions-architect-associate/page.tsx` 完全対策ガイド）
