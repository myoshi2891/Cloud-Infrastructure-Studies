...
- `/app`: Next.js App Router のページコンポーネント。
  ...
  - `/app/recommended-books/unix-linux-sysadmin-handbook`: 『UNIX and Linux System Administration Handbook』完全解説ガイド（Evi Nemeth et al. 原著、5部30章構成、基本管理・ネットワーキング・ストレージ・運用実践・セキュリティ、Mermaid 29図）。
