...
**スタンドアロン設定の考慮事項**:
- Google Workspace / Cloud Identity なしでのスタンドアロン組織の作成は例外的に可能だが、厳格な前提（例：特別なサポート申請またはGoogleの承認）が必要
...
- [ ] スタンドアロン組織は例外的に可能だが厳格な前提（例：特別なサポート申請やGoogleの承認）が必要であることを理解している
