...
- [x] **Step 3 (Refactor / Integration & Nav & Docs)**: `refactor(ccna): integrate Network Fundamentals guide into routing, archive html, and update docs` (`9779950`), 全H2タイトル完全一致修復 & スクロール同期ScrollSpy完全統合 & ヒーローレイアウト位置完全解決
