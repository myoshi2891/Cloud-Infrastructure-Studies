...
gcloud iam service-accounts create my-gsa --project=`
...
`gcloud iam service-accounts add-iam-policy-binding my-gsa@.iam.gserviceaccount.com \
  --role roles/iam.workloadIdentityUser \
  --member "serviceAccount:.svc.id.goog[app-namespace/my-ksa]"`
...
`kubectl annotate serviceaccount my-ksa \
  ...
  iam.gke.io/gcp-service-account=my-gsa@.iam.gserviceaccount.com`
